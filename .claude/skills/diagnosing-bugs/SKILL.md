...
The goal is not a clean repro but a **higher reproduction rate**. Loop the trigger 100x, parallelize, and stress, narrow timing window, inject sleeps. A 50%-flake bug is debuggable; 1% is not -- keep raising the rate until it's debuggable.
